...
local greek = {
	...
	"pi", "rho", "varrho", "sigma", "Sigma", "tau", "upsilon", "Upsilon", "phi", "varphi", "Phi",
	"chi", "psi", "omega", "Omega"
}

-- Common math symbols (binary operators, logic, set theory, etc.)
local symbols = {
	"parallel", "perp", "partial", "nabla", "hbar", "ell", "infty", "oplus", "ominus", "otimes",
	"oslash", "square", "star", "dagger", "vee", "wedge", "subseteq", "subset", "supseteq", "supset",
	"emptyset", "exists", "nexists", "forall", "implies", "impliedby", "iff", "setminus", "neg",
	"lor", "land", "bigcup", "bigcap", "cdot", "times", "simeq", "approx", "peq", "fa", "RR", "CC",
	"NN", "where", "disc", "mat", "if", "or", "so", "then", "st", "re", "im", "exp", "log", "ln"
}

-- Extended set of math symbols and operators
local more_symbols = {
	"leq", "geq", "neq", "gg", "ll", "equiv", "sim", "propto", "rightarrow", "leftarrow",
	"Rightarrow", "Leftarrow", "leftrightarrow", "to", "mapsto", "cap", "cup", "in", "sum",
	"prod", "exp", "ln", "log", "det", "dots", "vdots", "ddots", "pm", "mp", "int", "iint",
	"iiint", "oint"
}
...
return concat_arrays(
	...
	concat_arrays(
		add_snippets(more_symbols, "", "Extended symbol"),
		add_snippets(greek, "", "Greek letter")
	)
)
